...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_A_SYM = 3,                      /* A_SYM  */
  YYSYMBOL_B_SYM = 4,                      /* B_SYM  */
...
{
  "\"end of file\"", "error", "\"invalid token\"", "A_SYM", "B_SYM",
  "$accept", "input", "seq", "as", "bs", YY_NULLPTR
};
...
#line 1172 "mango.tab.c"
    break;


#line 1176 "mango.tab.c"
